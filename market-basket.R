...
#support = no. of time (A&B) bought / N
#confidence = no. of time (A&B) bought / no. of time A bought
#lift = support(A*B) / Support(A)*Support(B) [If the value is more thn 1, thn A & B are strongly related]
